...
# 3. SEGMENTED XOR: Apply 1106 only to the lower half (16 bytes)
# This respects the "2 of 2" duality structure
funds = 1106
final_int = halved_int ^ funds
final_hex = hex(final_int)[2:].zfill(64)

# 4. Generate Compressed WIF
compressed_payload = '80' + final_hex + '01'
print(f"Segmented XOR WIF: {base58_check_encode(compressed_payload)}")