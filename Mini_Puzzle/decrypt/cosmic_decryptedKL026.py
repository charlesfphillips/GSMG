...
# 4. SEGMENTED FUNDING (The Final Duality)
# Apply 1106 as an XOR to the 'End' of the shifted key
final_int = shifted_int ^ 1106
final_hex = hex(final_int)[2:].zfill(64)

# 5. Generate Compressed WIF
compressed_payload = '80' + final_hex + '01'
print(f"Targeted Architect WIF: {base58_check_encode(compressed_payload)}")