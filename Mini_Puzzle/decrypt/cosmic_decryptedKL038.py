...
# 3. THE MODULAR HALVING (Cosmic Inverse)
# Multiplying by the modular inverse of 2 mod N
inv_2 = pow(2, -1, N)
halved_int = (mirrored_int * inv_2) % N
...
print(f"Modular Duality WIF: {base58_check_encode(compressed_payload)}")